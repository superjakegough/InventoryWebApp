...
@Component
export default class EditATComponent extends Vue {
	$refs!: {
	...
	mounted() {
		this.loading = true;
		fetch('api/AT/GetByIdInventory?id=' + this.$route.params.id)
