...
namespace InventoryWebApp.Controllers
{
    ...
    public class ATController : Controller
    {
        ...
        public List<Reagent> GetInventory()
        {
            ...
            string query = "SELECT * FROM ATInventoryTable;";
        ...
        {
            string query = "SELECT * FROM ATArchiveTable;";
            using (SqlConnection conn = new SqlConnection(Connection.ConnString))
            {
                try
                {
        ...
        {
            string query = "SELECT * FROM ATInventoryTable WHERE Id=@Id;";
            using (SqlConnection conn = new SqlConnection(Connection.ConnString))
            {
                try
                {
        ...
        {
            string query = "SELECT * FROM ATArchiveTable WHERE Id=@Id;";
            using (SqlConnection conn = new SqlConnection(Connection.ConnString))
            {
                try
                {
        ...
        public int CreateInventory()
        {
            ...
            if (reagent != null)
            {
                string query = "IF NOT EXISTS (SELECT * FROM ATInventoryTable WHERE Name=@Name AND Supplier=@Supplier AND Batch=@Batch) " +
                "INSERT INTO ATInventoryTable (Name, Supplier, Batch, Validated, Expiry, Quantity, Minimum)" +
        ...
        public int CreateArchive(Reagent reagent)
        {
            if (reagent != null)
            {
                string query = "INSERT INTO ATArchiveTable (Id, Name, Supplier, Batch, Validated, Expiry, Minimum, Quantity) " +
        ...
        public int UpdateInventory()
        {
            ...
            if (after != null)
            {
                string query = "UPDATE ATInventoryTable" +
        ...
        public int UpdateArchive(Reagent reagent)
        {
            ...
            if (reagent != null)
            {
                string query = "UPDATE ATArchiveTable" +
        ...
        public int DeleteInventory()
        {
            ...
            if (reagent != null)
            {
                string query = "DELETE FROM ATInventoryTable WHERE Id=@Id;";
                using (SqlConnection conn = new SqlConnection(Connection.ConnString))
                {
                    try
                    {
        ...
        public int DeleteArchive()
        {
            ...
            if (reagent != null)
            {
                string query = "DELETE FROM ATArchiveTable WHERE Id=@Id;";
                using (SqlConnection conn = new SqlConnection(Connection.ConnString))
                {
                    try
                    {
