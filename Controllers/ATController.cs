    ...
    public class ATController : Controller
    {
        ...
        public int CreateInventory()
        {
            ...
            if (reagent != null)
            {
                ...
                "INSERT INTO ATInventoryTable (Name, Supplier, Batch, Validated, Expiry, Quantity)" +
        ...
        public int CreateArchive(Reagent reagent)
        {
            if (reagent != null)
            {
                string query = "INSERT INTO ATArchiveTable (Id, Name, Supplier, Batch, Validated, Expiry, Quantity) " +
