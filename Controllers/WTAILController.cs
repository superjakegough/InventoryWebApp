...
namespace InventoryWebApp.Controllers
{
    ...
    public class WTAILController : Controller
    {
        [HttpGet]
        [Route("GetInventory")]
        ...
        {
            string query = "SELECT * FROM WTAILArchiveTable;";
            using (SqlConnection conn = new SqlConnection(Connection.ConnString))
            {
                try
                {
        ...
        {
            string query = "SELECT * FROM WTAILInventoryTable WHERE Id=@Id;";
            using (SqlConnection conn = new SqlConnection(Connection.ConnString))
            {
                try
                {
        ...
        {
            string query = "SELECT * FROM WTAILArchiveTable WHERE Id=@Id;";
            using (SqlConnection conn = new SqlConnection(Connection.ConnString))
            {
                try
                {
        ...
        public int UpdateInventory()
        {
            ...
            if (after != null)
            {
                string query = "UPDATE WTAILInventoryTable" +
        ...
        public int UpdateArchive(Reagent reagent)
        {
            ...
            if (reagent != null)
            {
                string query = "UPDATE WTAILArchiveTable" +
        ...
        public int DeleteInventory()
        {
            ...
            if (reagent != null)
            {
                string query = "DELETE FROM WTAILInventoryTable WHERE Id=@Id;";
                using (SqlConnection conn = new SqlConnection(Connection.ConnString))
                {
                    try
                    {
        ...
        public int DeleteArchive()
        {
            ...
            if (reagent != null)
            {
                string query = "DELETE FROM WTAILArchiveTable WHERE Id=@Id;";
                using (SqlConnection conn = new SqlConnection(Connection.ConnString))
                {
                    try
                    {
